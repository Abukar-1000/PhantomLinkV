...
const uint32_t TableStruct_Request_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::test::Request, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::test::Request, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::test::Request, _impl_.msg_),
  PROTOBUF_FIELD_OFFSET(::test::Request, _impl_.type_),
  0,
  1,
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 8, -1, sizeof(::test::Request)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::test::_Request_default_instance_._instance,
};

const char descriptor_table_protodef_Request_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rRequest.proto\022\004test\"-\n\007Request\022\013\n\003msg\030"
  "\001 \001(\t\022\025\n\004type\030\002 \001(\t:\007Request"
  ;
static ::_pbi::once_flag descriptor_table_Request_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_Request_2eproto = {
    false, false, 68, descriptor_table_protodef_Request_2eproto,
    "Request.proto",
...
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString Request::Impl_::_i_give_permission_to_break_this_code_default_type_{{{"Request", 7}}, {nullptr}};
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "test.Request.msg");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "test.Request.type");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
...
template<> PROTOBUF_NOINLINE ::test::Request*
Arena::CreateMaybeMessage< ::test::Request >(Arena* arena) {
